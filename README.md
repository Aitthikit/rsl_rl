...
For a demo configuration of Distillation with Perception encoder,please check the [distillation_with_encoder_config.py](config/distillation_with_encoder_config.py) file.
